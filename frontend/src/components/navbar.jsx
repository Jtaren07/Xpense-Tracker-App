      ...
      <div>
        <Menu.Button className=''>
          <div className='flex items-center gap-2'>
            <div className='w-10 2xl:w-12 h-10 2xl:h-12 rounded-full text-white bg-violet-600 cursor-pointer flex items-center justify-center uppercase'>
              <p className='text-2xl font-bold'>
                {user?.firstname?.charAt(0) || 'U'}
              </p>
            </div>
            <MdOutlineKeyboardArrowDown className='text-gray-500 dark:text-gray-400' />
          </div>
        </Menu.Button>
      </div>
      <TransitionWrapper>
        <Menu.Items className='absolute z-50 right-0 mt-2 w-56 origin-top-right rounded-md bg-white dark:bg-slate-800 shadow-lg ring-1 ring-black/5 focus:outline-none'>
